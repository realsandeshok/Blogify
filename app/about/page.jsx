...
const page = () => {
  return (
    <div>
      <div className="my-2 flex text-2xl font-bold justify-start text-[var(--softTextColor)]">
        Welcome to Blogify, your ultimate destination for seamless and intuitive
        blogging.
      </div>
      <div className="about pt-5 text-[var(--softTextColor)]">
        <div>
